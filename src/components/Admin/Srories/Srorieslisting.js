...
class Srorieslisting extends React.Component {
    ...
    async componentDidMount() 
    {
        ...
        {
            var url = 'http://pramesh.justcodenow.com/backend/api/all_stories';
        }
    ...
    deletedata(e) 
    {
        ...
        if (answer_array[2] == 'localhost:3000') 
        {
            ...
            var del = 'http://pramesh.justcodenow.com/backend/api/stories_delete';
        }
                                            ...
                                            <tbody>
                                                {
                                                    ...
                                                    (
                                                        <tr>
                                                            <th>{index+1}</th>
                                                            <td><img className="h-101 w-101" src={storie.vImage} /></td>
                                                            <td>{storie.vTitle}</td>

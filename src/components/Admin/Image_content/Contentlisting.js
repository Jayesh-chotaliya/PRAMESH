...
class Banner_listing extends React.Component {
    ...
    async componentDidMount() 
    {
        ...
        {
            var url = 'http://pramesh.justcodenow.com/backend/api/all_image_content_get';
        }
    ...
    deletedata(e) 
    {
        ...
        if (answer_array[2] == 'localhost:3000') 
        {
            ...
            var del = 'http://pramesh.justcodenow.com/backend/api/image_content_delete';
        }
                                                    ...
                                                    (
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button id={`${banner.iContentId}`} class="btn myBtn2" onClick={this.deletedata}>Delete</button>
                                                            </td>

...
const User_Edit = () =>
{
    ...
    {
        var urls = `http://pramesh.justcodenow.com/backend/api/all_user_get?iUserId=${iUserId}`;
    }
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-lg-6">
                                                    <div className="form-group">
                                                        ...
                                                        <input value={Email} onChange={(e) => setEmail(e.target.value)} type="text" id="vEmail" className="form-control" placeholder="Email" />

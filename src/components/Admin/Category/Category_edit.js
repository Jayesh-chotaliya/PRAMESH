...
const Category_edit = () => {
    ...
    function addcategory() 
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var url = 'http://pramesh.justcodenow.com/backend/api/category_add';
        }
    ...
    {
        var urls = `http://pramesh.justcodenow.com/backend/api/all_category_get?iCategoryId=${iCategoryId}`;
    }

...
class Subcategory_listing extends React.Component
{
    ...
    async componentDidMount() 
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var url = 'http://pramesh.justcodenow.com/backend/api/all_subcategory_get';
        }
    ...
    deletedata(e)
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var del = 'http://pramesh.justcodenow.com/backend/api/delete_subcategory';
        }
                                                    ...
                                                    (
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button id={`${cat.iSubcategoryId}`} class="btn myBtn2" onClick={this.deletedata}>Delete</button>
                                                            </td>
                                                        </tr>
                                                    ))
                                                }

...
const Register = () => {
    ...
    function validateEmail() {
        ...
        if (pattern.test(emailText)) {
            if (answer_array[2] == 'localhost:3000') {
                ...
                var email_verify = 'http://pramesh.justcodenow.com/backend/api/email_varify';
            }
    ...
    function register_data_save()
    {
        ...
        if (answer_array[2] == 'localhost:3000') {
            ...
            var register = 'http://pramesh.justcodenow.com/backend/api/register';
        }
                ...
                <div className="right1">
                    ...
                    <div className="info">
                        ...
                        <form id="register" autocomplete="off">
                            ...
                            <div className="group">
                                <input type="password" onChange={(e) => setConPassword(e.target.value)} name="setpass" id="setpass" />
                                <span className="highlight"></span>
                                <span className="bar"></span>

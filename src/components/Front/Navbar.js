      ...
      <nav className={`navbar ${stick ? "sticked" : ""} navbar-expand-lg navbar-light bg-light`}>
                        ...
                        {header.sub.map(function (sub, ids) {
                          ...
                          return (
                            <div className={p}>
                              ...
                              <Link
                                to={`/product-listing/${name}/${sub.iSubcategoryId}`}
                              >
                                <a
                                  id={`${sub.iSubcategoryId}`}
        ...
        <div className="d-flex iconBox">
          <div className="icons ">
            ...
            <span >
              <i className="fa fa-heart-o" aria-hidden="true" onClick={poped}></i>
            </span>
            <span className="position-relative ">
            {
              iUserId ?
              <span className="luser" onClick={logPop}>JC</span>
              :
              <Link to="/register">
                <i className="fa fa-user" aria-hidden="true"></i>
              </Link>
            }
            <span className={`logout ${ logpop ? "d-inline-flex" : "d-none" }`}> <span>Logout</span> <i className="fa fa-sign-out" aria-hidden="true"></i> </span>
